...
def setup_module():
    global subset_b0, subset_dwi_data, subset_t2, subset_b0_img, subset_t2_img, gtab, hardi_affine, MNI_T2_affine
    ...
    subset_dwi_data = nib.Nifti1Image(hardi_data[40:45, 40:45, 40:45], hardi_affine)
