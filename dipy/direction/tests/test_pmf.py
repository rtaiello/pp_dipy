...
def test_boot_pmf():
    ...
    with warnings.catch_warnings():
        ...
        boot_pmf_gen_sh4 = BootPmfGen(
            data, sphere=hsph_updated, model=csd_model, sh_order=4
        )
    ...
    with warnings.catch_warnings():
        ...
        boot_pmf_gen_sh8 = BootPmfGen(
            data, model=csd_model, sphere=hsph_updated, sh_order=8
        )
