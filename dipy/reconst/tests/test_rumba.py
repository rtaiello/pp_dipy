...
def test_rumba():
    ...
    # Models to validate
    rumba_smf = RumbaSDModel(
        gtab, n_iter=20, recon_type="smf", n_coils=1, sphere=sphere
    )
    rumba_sos = RumbaSDModel(
        gtab, n_iter=20, recon_type="sos", n_coils=32, sphere=sphere
    )
...
def test_mvoxel_rumba():
    ...
    # Models to validate
    rumba_smf = RumbaSDModel(gtab, n_iter=5, recon_type="smf", n_coils=1, sphere=sphere)
    rumba_sos = RumbaSDModel(
        gtab, n_iter=5, recon_type="sos", n_coils=32, sphere=sphere
    )
    model_list = [rumba_smf, rumba_sos]
...
def test_mvoxel_global_fit():
    ...
    rumba_r = RumbaSDModel(
        gtab, recon_type="smf", n_iter=5, n_coils=1, R=2, voxelwise=False, sphere=sphere
    )
    rumba_r_tv = RumbaSDModel(
        gtab,
        recon_type="smf",
        n_iter=5,
        n_coils=1,
