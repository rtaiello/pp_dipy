...
def test_mcsd_model_delta():
    ...
    with warnings.catch_warnings():
        ...
        response = multi_shell_fiber_response(
            sh_order, [0, 1000, 2000, 3500], wm_response, gm_response, csf_response
        )
    with warnings.catch_warnings():
        warnings.filterwarnings(
            "ignore",
...
def test_multi_shell_fiber_response():
    ...
    with warnings.catch_warnings(record=True) as w:
        ...
        response = multi_shell_fiber_response(
            sh_order, [1000, 2000, 3500], wm_response, gm_response, csf_response
        )
...
def test_auto_response_msmt():
    ...
    with warnings.catch_warnings(record=True) as w:
        ...
        (
            response_from_mask_wm,
            response_from_mask_gm,
            response_from_mask_csf,
