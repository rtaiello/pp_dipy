...
def test_single_fiber_model():
    ...
    assert_almost_equal(f_norm, 1.0)
    ...
    assert_array_almost_equal(wmtiF.restricted_evals, np.array([ADi, RDi, RDi]))
...
def test_dki_micro_awf_only():
    ...
    assert_raises(ValueError, _help_test_awf_only, dkiF, "dkimicrofit.hindered_evals")
    assert_raises(ValueError, _help_test_awf_only, dkiF, "dkimicrofit.restricted_evals")
    assert_raises(
        ValueError, _help_test_awf_only, dkiF, "dkimicrofit.axonal_diffusivity"
    )
    assert_raises(ValueError, _help_test_awf_only, dkiF, "dkimicrofit.hindered_ad")
    assert_raises(ValueError, _help_test_awf_only, dkiF, "dkimicrofit.hindered_rd")
    assert_raises(ValueError, _help_test_awf_only, dkiF, "dkimicrofit.tortuosity")
