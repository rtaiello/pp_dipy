...
from dipy.core.gradients import gradient_table, unique_bvals_tolerance, get_bval_indices
...
class RumbaSDModel(OdfModel):
    def __init__(
        ...
        if voxelwise and verbose:
            warnings.warn("Verbosity has no effect in voxelwise fit", UserWarning)
