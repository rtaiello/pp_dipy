...
==========================================
This example explains how to model 2D images using the Symmetric
...
that can be used to model images back and forth between the static and
moving domains
"""
...
"""
Now let's model a couple of slices from a b0 image using the Cross
