...
This example explains how to compute a transformation to model two 3D
...
"""
Now let's model these volumes together without any masking. For the purposes
...
"""
Let's try to model these new images without a mask.
"""
...
"""
Now we will attempt to model the images using the masks that we defined.
...
e.g., to model a series of images to a single static image.

Let's make a series of volumes to demonstrate this idea, and model the
