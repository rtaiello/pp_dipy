...
additive_share.so: ${PKGDIR}/mpc/additive_share.pyx
mpc_crosscorr.so: ${PKGDIR}/mpc/mpc_crosscorr.pyx
mpc_sumsqdiff.so: ${PKGDIR}/mpc/mpc_sumsqdiff.pyx
mpc_parzenhist.so: ${PKGDIR}/mpc/mpc_parzenhist.pyx
